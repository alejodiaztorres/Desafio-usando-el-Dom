...
function encabezado() {
    ...
    img.className = 'd-block d-block mx-auto mb-4';
    img.src = 'logo.png';
    img.width = 72;
    img.height = 72;
    div.appendChild(img);
...
//Funcion que recibe datos para agregar a la lista de la carta
...
//función carro
function carro() {
    //Creando texto Your cart
    var container = document.createElement('div');
    container.className = 'col-md-4 order-md-2 mb-4';
    var h4 = document.createElement('h4');
    h4.className = 'd-flex justify-content-between align-items-center mb-3 pt-5';
    var span = document.createElement('span');
    span.className = 'text-muted';
    span.appendChild(document.createTextNode('Your cart'));

    //Creando número 3 (cantidad de productos)
    h4.appendChild(span);
    ...
    //Creando lista con los parámetros que recibirá la función item_carro
...
// Recibo el texto y lo convierto en link
...
function footer() {
    ...
    //Enviando a función que convierte los textos en Links
...
//Agrego el encabezado en un div clase container
...
//Agrego el carro en una clase row y el footer
